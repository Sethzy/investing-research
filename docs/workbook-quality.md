...
2. Render or open every visible sheet. Review Summary, Assumptions, Historical, Operating, Valuation, Sensitivities, Checks and Readme. Inspect both the normal sheet view and print/export layout when sharing a PDF.
